  ...
  describe Encoder do
    ...
    context 'hexification' do
      ...
      it 'supports an alternative method name', :vcr do
        Timecop.freeze Time.local 2016, 01, 05
        expect(described_class.encode 'http://heyre.be/snake/feeds.json').to eq (
          ''
        )
        Timecop.return
      end
    ...
    context 'dehexification' do
      ...
      it 'supports an alternative method name' do
        expect(described_class.decode '').to eq (
          "1451987805|http://heyre.be/catface/flea-treatment|{\"Accept\":\"application/json\"}|b7a56fb98d0e164f8f4f0dab90c93b621dc3bbf49d2ef058775e3999d75b9a88"
        )
      end
    end
